                ...
                <div class="col-12  align-self-center">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="card-title">Analitic Data Customer</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['wa']['order']); ?></div>
                                        </div>

                                        <div class="progress progress-sm">
                                            <?php
                                            $percent_wa = (($channel['wa']['order'] - $channel['wa']['sisa']) / $channel['wa']['order']) * 100;
                                            ?>
                                ...
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['email']['order']); ?></div>
                                        </div>
                                        <div class="progress progress-sm">
                                            <?php
                                            $percent_email = (($channel['email']['order'] - $channel['email']['sisa']) / $channel['email']['order']) * 100;
                                            ?>
                                            <div class="progress-bar bg-blue" style="width: <?php echo $percent_wa; ?>%" role="progressbar" aria-valuenow="<?php echo $percent_wa; ?>" aria-valuemin="0" aria-valuemax="100">
                                                <span class="visually-hidden"><?php echo number_format($percent_wa, 2); ?>% Complete</span>
                                            </div>
                                ...
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['sms']['order']); ?></div>
                                        </div>
                                        <div class="progress progress-sm">
                                            <?php
                                            $percent_sms = (($channel['sms']['order'] - $channel['sms']['sisa']) / $channel['sms']['order']) * 100;
                                            ?>
                                            <div class="progress-bar bg-blue" style="width: <?php echo $percent_wa; ?>%" role="progressbar" aria-valuenow="<?php echo $percent_wa; ?>" aria-valuemin="0" aria-valuemax="100">
                                                <span class="visually-hidden"><?php echo number_format($percent_wa, 2); ?>% Complete</span>
                                            </div>
                                ...
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['ovr']['order']); ?></div>
                                        </div>
                                        <div class="progress progress-sm">
                                            <?php
                                            $percent_ovr = (($channel['ovr']['order'] - $channel['ovr']['sisa']) / $channel['ovr']['order']) * 100;
                                            ?>
                                            <div class="progress-bar bg-blue" style="width: <?php echo $percent_wa; ?>%" role="progressbar" aria-valuenow="<?php echo $percent_wa; ?>" aria-valuemin="0" aria-valuemax="100">
                                                <span class="visually-hidden"><?php echo number_format($percent_wa, 2); ?>% Complete</span>
                                            </div>
                                ...
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['tvms']['order']); ?></div>
                                        </div>
                                        <div class="progress progress-sm">
                                            <?php
                                ...
                                <div class="col-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="h4 mb-3 text-center"><?php echo number_format($channel['PSTN']['order']); ?></div>
                                        </div>
                                        <div class="progress progress-sm">
                                            <?php
                                            $percent_obc = (($channel['PSTN']['order'] - $channel['PSTN']['sisa']) / $channel['PSTN']['order']) * 100;
                                            ?>
                                            <div class="progress-bar bg-blue" style="width: <?php echo $percent_wa; ?>%" role="progressbar" aria-valuenow="<?php echo $percent_wa; ?>" aria-valuemin="0" aria-valuemax="100">
                                                <span class="visually-hidden"><?php echo number_format($percent_wa, 2); ?>% Complete</span>
                                            </div>
                                    ...
                                    <table id="byagent" class="table dataTable table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php
                                                $m_channel = array("wa" => "Whatsapp", "email" => "Email", "sms" => "SMS", "ovr" => "OVR", "tvms" => "TVMS", "PSTN" => "OBC");
                                        ...
                                        <tbody>
                                            ...
                                            for ($day = 1; $day <= 31; $day++) {
                                                ...
                                                foreach ($m_channel as $ch => $vl) {
                                                    $bg = "";
                                                    if ($channel[$ch][$day]['order'] > 0) {
                                                        $bg = "background:mediumspringgreen;";
                                                    }
                                                    echo "<td style='text-align:center;$bg'>" . number_format($channel[$ch][$day]['order']) . "</td>";
                                                }
