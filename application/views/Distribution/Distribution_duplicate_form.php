...
<?php echo card_open('Data Duplicate DAPROS', 'bg-green', true) ?>

<div class="col-lg-12 col-xs-12 blink_me_veri">
    <div class="small-box bg-red">
        <div class="inner">
            <h3 id="verified"><?php echo $data['num']; ?></h3>
            <p>Jumlah Data DUPLICATE Yang akan diupdate!</p>
        </div>
    ...
    <div class='row'>
        <div class='col-md-12 col-xl-12'>
            <div class='form-group'>
                ...
                <button type='submit' class='btn btn-danger'><i class="fe fe-save"></i> UPDATE DUPLICATE STATUS!</button>
