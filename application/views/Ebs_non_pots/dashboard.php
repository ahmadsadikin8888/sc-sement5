                                ...
                                <table id="datalist" class="table dataTable table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <td style='text-align:center;'>Customer Ref</td>
                                            <td style='text-align:center;'>Periode</td>
                                            <!-- <td style='text-align:center;'>Alamat</td> -->
                                            <td style='text-align:center;'>Billing Month</td>
                                            <td style='text-align:center;'>Due Date</td>
                                            <td style='text-align:center;'>PKP</td>
                                            <td style='text-align:center;'>CIDNAS</td>
