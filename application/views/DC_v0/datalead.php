                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($wa['total']); ?></h2>
                        ...
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($email['total']); ?></h2>
                        ...
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($sms['total']); ?></h2>
                    ...
                    <div class="row">
                        <div class="col-3  mt-3">
                            <!-- <div class="card">
                                <div class="card-body text-success border-bottom border-success border-w-5">
                                    ...
                                    <h6 class="text-center">CAMPAIGN</h6>
                                </div>
                            </div> -->
                        </div>
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($ovr['total']); ?></h2>
                        ...
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($tvms['total']); ?></h2>
                        ...
                        <div class="col-3  mt-3">
                            <div class="card">
                                <div class="card-body text-info border-bottom border-info border-w-5">
                                    <h2 class="text-center"><?php echo number_format($obc['total']); ?></h2>
