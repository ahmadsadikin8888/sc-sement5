var extensionId = 0;
var currentAgentStatus = 'Not Ready';
...
window.initCustomWebphone = function () //Bikin komponen Aux dan floating dialer
{
    ...
    // newDivItem.setAttribute('class', 'card card-purple');
    // newDivItem.setAttribute('style', 'display:none;background-color: rgba(0, 0, 0, 0.1);');
    newDivItem.innerHTML = '<input type="text" class="form-control" placeholder="Destination number" id="destnumber" autocapitalize="off"><br><button class="btn btn-success btn-block" type="button" id="btn_call" onclick="Call();">Call</button><div class="row py-1" id="incoming_call_layout"><div class="btn-group w-100" role="group"><button type="button" class="btn btn-success" id="btn_accept" onclick="Accept();">Accept</button><button type="button" class="btn btn-danger" id="btn_reject" onclick="Reject();">Reject</button></div></div><iframe allow="microphone; camera" style="display:none" height="0" width="0" id="loader"></iframe><div id="video_container" style="display: none;"></div></div>';
